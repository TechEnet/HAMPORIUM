...
const ProductMasterImport = () => {
  ...
  const confirmImport = async () => {
    ...
    if (createCount + updateCount === 0) {
      setError(
        "There are no CREATE or UPDATE rows to import."
      );
      return;
    }

    const confirmed = window.confirm(
      `Import ${createCount} new and ${updateCount} updated records into MongoDB? REVIEW and ERROR rows will be skipped.`
    );
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-black/50">
            Safely analyze, review and synchronize the Product Master into
            HAMPORIUM without modifying the source Excel file.
          </p>
        </div>
        ...
        <div className="p-5 sm:p-7">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            <InfoCard
              ...
              text="Analyze never changes MongoDB."
            />
            <InfoCard
            ...
            <InfoCard
              ...
              text="Base price, GST and HSN/SAC stay separate; REVIEW and ERROR rows remain protected."
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-h-[94vh] w-full max-w-5xl overflow-y-auto rounded-3xl bg-[#F7F6F3] shadow-2xl">
        ...
        >
          ...
          <ReviewSection
            ...
            highlight
            description="Enter the true usable inside dimensions. These values drive the hamper fit engine."
          >
            <DimensionFields
