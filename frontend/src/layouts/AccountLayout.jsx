    ...
    >
      ...
      <div className="sticky top-0 z-40 flex h-[68px] items-center justify-between border-b border-black/[0.07] bg-[#FFFDF9]/95 px-3.5 shadow-[0_8px_30px_rgba(30,22,12,.06)] backdrop-blur-xl sm:px-5 lg:hidden">
        <button type="button" onClick={() => navigate("/")} className="flex min-w-0 items-center gap-2.5 text-left">
          ...
          <span className="min-w-0"><strong className="block truncate font-serif text-[17px] font-semibold tracking-[0.08em] text-[#171717]">HAMPORIUM</strong><small className="mt-0.5 block truncate text-[8px] font-extrabold uppercase tracking-[0.18em] text-[#A77C26]">Private Account</small></span>
        </button>
